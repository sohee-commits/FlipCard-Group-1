...
def openCards():
    ...
    question_1 = Button(
        ...
        width=35,
        height=3,
        text='Какие скобки используются для списка в Python?', 
        wraplength=300,
    ...
    question_2 = Button(
        ...
        width=35,
        height=3,
        text='Как делать срезы списков в Python?', 
        wraplength=300,
        font=('Roboto', 16, 'normal'),
        foreground='#111111',
        background='#e8e8e8',
    ...
    answer_1 = Button(
        ...
        width=35,
        height=4,
        text='Чтобы Python понял, что имеет дело со списком, нужно заключить все элементы в квадратные скобки.', 
        wraplength=300,
        font=('Roboto', 12, 'bold'),
        foreground='#111111',
        background='#e8e8e8',
    ...
    answer_2 = Button(
        ...
        width=35,
        height=4,
        text='list_name[НАЧАЛО:КОНЕЦ:ШАГ]', 
        wraplength=300,
        font=('Roboto', 12, 'bold'),
        foreground='#111111',
        background='#e8e8e8',
